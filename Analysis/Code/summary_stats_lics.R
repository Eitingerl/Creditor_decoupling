...
datasummary(All(df_health_clean) ~ N + Mean + SD + Min + Max, 
            ...
            title = "Summary statistics, health spending, low-income countries",
            notes = "The statistics of explanatory variables refer to their one-year lagged version which is used in the models.",
            output = "Analysis/LIC_results/General_tables/summary_table_health_exp.tex")
...
datasummary(All(df_educ_clean) ~ N + Mean + SD + Min + Max, 
            data = df_educ_clean,
            title = "Summary statistics, education spending, low-income countries",
            notes = "The statistics of explanatory variables refer to their one-year lagged version which is used in the models.",
            output = "Analysis/LIC_results/General_tables/summary_table_educ_exp.tex")
