...
ggsave("Analysis/MIC_results/Figures/iv_vs_avg_share_trad_cred.png", width = 12, height = 8)
...
ggsave("Analysis/MIC_results/Figures/iv_health_exp_trends.png", width = 12, height = 8)
...
ggsave("Analysis/MIC_results/Figures/iv_educ_exp_trends.png", width = 12, height = 8)
...
datasummary_correlation(cor_matrix,
                        ...
                        title = "Correlation matrix of independent variables, middle-income countries",
                        output = "Analysis/MIC_results/General_tables/correlation_ind_vars_table.tex", 
                        replace = TRUE,
          silent = FALSE)
