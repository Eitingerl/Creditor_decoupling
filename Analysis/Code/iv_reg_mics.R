...
etable(est_iv1.1, est_iv1.2, est_iv2.1, est_iv2.2, # first stage
       ...
       tex = TRUE,
       title = "Baseline IV specification, first-stage results, middle-income countries", 
       label = "tab:results_baseline_iv_overall_1st-stage_other",
       file = "Analysis/MIC_results/IV_tables/results_baseline_iv_overall_1st-stage.tex", 
       replace = TRUE)
...
etable(est_iv1.1, est_iv1.2, est_iv2.1, est_iv2.2, # second stage
       ...
       style.tex = style.tex(depvar.title = "Dependent Variables:",
                             model.title = "Model:"),
       title = "Baseline IV results, middle-income countries",
       label = "tab:results_baseline_iv_overall_other",
       tex = TRUE, 
       file = "Analysis/MIC_results/IV_tables/results_baseline_iv_overall_w_ar.tex", 
       replace = TRUE)
...
etable(est_iv1.1, est_iv1.2, est_iv1.3, est_iv2.1, est_iv2.2, est_iv2.3,
       ...
       style.tex = style.tex(depvar.title = "Dependent Variables:",
                             model.title = "Model:"),
       title = "Baseline IV results, middle-income countries",
       label = "tab:app_results_baseline_iv_overall_other",
       tex = TRUE, 
       file = "Analysis/MIC_results/IV_tables/IV_all_ctrls_appendix.tex", 
       replace = TRUE)
