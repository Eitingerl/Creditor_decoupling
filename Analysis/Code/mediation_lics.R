...
################################################################################
dir.create("Analysis/LIC_results/Mediation_tables", recursive = TRUE, showWarnings = FALSE)
...
print(xtable(summary_table_health, 
             ...
             digits = 3), 
      type = "latex", 
      file = "Analysis/LIC_results/Mediation_tables/joint_mediation_results_health.tex")
...
print(xtable(summary_table_educ, 
             ...
             digits = 3), 
      type = "latex", 
      file = "Analysis/LIC_results/Mediation_tables/joint_mediation_results_educ.tex")
