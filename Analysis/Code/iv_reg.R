...
etable(est_iv1.1, est_iv1.2, est_iv2.1, est_iv2.2, # first stage
       ...
       tex = TRUE,
       title = "Baseline IV specification, first-stage results,", # will plug in country type manually in Latex
       label = "tab:results_baseline_iv_overall_1st-stage_",
       file = "IV_tables/results_baseline_iv_overall_1st-stage.tex", 
       replace = TRUE)
...
etable(est_iv1.1, est_iv1.2, est_iv2.1, est_iv2.2, # second stage
       ...
       title = "Baseline IV results,",
       label = "tab:results_baseline_iv_overall_",
       tex = TRUE, 
       file = "IV_tables/results_baseline_iv_overall_w_ar.tex", 
       replace = TRUE)
...
etable(est_iv1.1, est_iv1.2, est_iv1.3, est_iv2.1, est_iv2.2, est_iv2.3,
       ...
       dict = c("ihme_health_exp_gdp" = "Health spending (share of GDP)",
                ...
                "avg_int_rate_lag1" = "Average interest rate"),
       title = "Baseline IV results, ",
       label = "tab:app_results_baseline_iv_overall_",
       tex = TRUE, 
       file = "IV_tables/IV_all_ctrls_appendix.tex", 
       replace = TRUE)
