...
# create vectors of key Paris-Club and MDB creditors and low-income debtors 
trad_cred <- c("Australia", "Austria", "Belgium", "Canada", # Paris Club
               "Denmark", "Finland", "France", "Germany, Fed. Rep. of", 
               "Ireland",  "Italy", "Japan", "Netherlands", "Norway", 
               #"Russian Federation", - joined in 1997 but perhaps not a traditional creditor in the sense of the others
...
# Write as Excel file
write_xlsx(wide_final_data_ppg_debt_total, "Construct_dataset/PC_MDBs_only/final_data_ppg_debt_total_pc_MDBs.xlsx") 
...
write.csv(data_stock, "Construct_dataset/PC_MDBs_only/debt_stock_official_pc_MDBs.csv", row.names = FALSE)
...
write.csv(data_commit, "Construct_dataset/PC_MDBs_only/debt_commitments_pc_MDBs.csv", row.names = FALSE)
rm(data_commit)
...
write.csv(data_interest, "Construct_dataset/PC_MDBs_only/debt_interest_rates_pc_MDBs.csv", row.names = FALSE)
rm(data_interest) 


# Load the saved CSVs
stock_df <- read_csv("Construct_dataset/PC_MDBs_only/debt_stock_official_pc_MDBs.csv")
commit_df <- read_csv("Construct_dataset/PC_MDBs_only/debt_commitments_pc_MDBs.csv")
int_df   <- read_csv("Construct_dataset/PC_MDBs_only/debt_interest_rates_pc_MDBs.csv")
...
write_xlsx(final_panel_dac_df, "Construct_dataset/PC_MDBs_only/debt_data_creditors_pc_MDBs.xlsx") # save as Excel file
...
write_xlsx(wide_loan_terms_data, "Construct_dataset/PC_MDBs_only/loan_terms_data_pc_MDBs.xlsx")
...
write_xlsx(wide_controls_data, "Construct_dataset/PC_MDBs_only/controls_data_dac_pc_MDBs.xlsx")
...
write_xlsx(df_debt, "Construct_dataset/PC_MDBs_only/debt_data_pc_MDBs.xlsx")                    
...
write_xlsx(dev_ind_data, "Construct_dataset/PC_MDBs_only/dev_ind_data_pc_MDBs.xlsx")
...
write_xlsx(master_df, "Analysis/master_data_pc_MDBs.xlsx")  
