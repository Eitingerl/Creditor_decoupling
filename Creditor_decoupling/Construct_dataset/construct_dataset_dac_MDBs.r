...
# create vectors of key DAC and MDB creditors and low-income debtors 
...
# Write as Excel file
write_xlsx(wide_final_data_ppg_debt_total, "Construct_dataset/DAC_MDBs_only/final_data_ppg_debt_total_dac_MDBs.xlsx") 
...
write.csv(data_stock, "Construct_dataset/DAC_MDBs_only/debt_stock_official_dac_MDBs.csv", row.names = FALSE)
...
write.csv(data_commit, "Construct_dataset/DAC_MDBs_only/debt_commitments_dac_MDBs.csv", row.names = FALSE)
rm(data_commit)
...
write.csv(data_interest, "Construct_dataset/DAC_MDBs_only/debt_interest_rates_dac_MDBs.csv", row.names = FALSE)
rm(data_interest) 


# Load the saved CSVs
stock_df <- read_csv("Construct_dataset/DAC_MDBs_only/debt_stock_official_dac_MDBs.csv")
commit_df <- read_csv("Construct_dataset/DAC_MDBs_only/debt_commitments_dac_MDBs.csv")
int_df   <- read_csv("Construct_dataset/DAC_MDBs_only/debt_interest_rates_dac_MDBs.csv")
...
write_xlsx(final_panel_dac_df, "Construct_dataset/DAC_MDBs_only/debt_data_dac_creditors_dac_MDBs.xlsx") # save as Excel file
...
write_xlsx(wide_loan_terms_data, "Construct_dataset/DAC_MDBs_only/loan_terms_data_dac_MDBs.xlsx")
...
write_xlsx(master_df, "Analysis/master_data_dac_MDBs_only.xlsx")  
